...
class Maze:
  ...
  def plot_map(self):
      ...
      self.map_plot_copy[start[0]][start[1]] = maze_map.r2_start_id
      self.map_plot_copy[goal[0]][goal[1]] = maze_map.r2_goal_id
      
      
      start = self.getStartState(3)
      goal = self.getGoalState(3)
      self.map_plot_copy[start[0]][start[1]] = maze_map.r3_start_id
      self.map_plot_copy[goal[0]][goal[1]] =  maze_map.r3_goal_id
